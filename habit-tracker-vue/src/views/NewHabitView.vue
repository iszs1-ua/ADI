<!-- src/views/NewHabitView.vue -->
<template>
  <main class="outlet">
    <section data-component="HabitForm" class="habit-form">
      <h2 class="habit-form__heading">Crear Nuevo Hábito</h2>
 ...
 * Valida los datos y llama al store para crear el hábito
 */
