# Práctica Evaluable 3: Frameworks Javascript (Vue.js)
...
Esta aplicación es un "Habit Tracker" (Gestor de Hábitos) desarrollado con **Vue 3 (Composition API)** y **Vite**. Permite a los usuarios registrarse, iniciar sesión y gestionar sus hábitos diarios.

## Tecnologías y Extras Implementados
- **Framework:** Vue 3 + Vite.
- **Estado:** Pinia (Stores para Auth y Hábitos).
- **Routing:** Vue Router (con protección de rutas).
- **Backend:** PocketBase.
- **Extras:**
  - Validaciones de formularios (visuales y lógicas).
  - Transiciones y animaciones (listas y modales).
  - Paginación y filtrado en el cliente/servidor.
